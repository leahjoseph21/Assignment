...
/*  The following constructor added by P. Mohan on February 8, 2019 */
    ...
    */
	...
	String filename = "C:\\Course\\COMP3609\\2018\\SideScroller-Brackeen\\images\\" + name;
...
System.out.println("Image file opened: " + filename);
    ...
    public TileMap loadNextMap() {
        ...
        while (map == null) {
            currentMap++;
   	    String mapFile = "C:\\Course\\COMP3609\\2018\\SideScroller-Brackeen\\maps\\map" + currentMap + ".txt";
            try {		
		map = loadMap(mapFile);
/*
                map = loadMap(
...
*/
    ...
    public TileMap reloadMap() {
        try {
            return loadMap(
                "C:\\Course\\COMP3609\\2018\\SideScroller-Brackeen\\maps\\map" + currentMap + ".txt");
        }
        catch (IOException ex) {
            ex.printStackTrace();
            return null;
    ...
    public void loadTileImages() {
        ...
        while (true) {
            ...
            File file = new File("C:\\Course\\COMP3609\\2018\\SideScroller-Brackeen\\images\\" + name);
            if (!file.exists()) {
